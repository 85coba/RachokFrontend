  ...
  <v-container fluid>
    ...
    <section>
      ...
      <v-layout justify-center>
              ...
              <v-icon x-large dark>mdi-telegram</v-icon>
      ...
      <v-layout row wrap align-center>
        <v-flex xs12 class="text-xs-center">
          <div class="white--text ml-3">
            Made with
            <v-icon class="red--text">mdi-heart</v-icon>using
